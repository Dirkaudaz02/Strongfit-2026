...
export const RAW_SCHEDULE = [
    ...
    { d: "Viernes 30", c: "Advance H", s: "Coca-Cola (Ev 2)", p: "Heats 1-3", t: "14:45", te: "15:08", type: "heat", h: [] },
    ...
    { d: "Viernes 30", c: "Rookie H", s: "Coca-Cola (Ev 2)", p: "Heats 1-5", t: "15:48", te: "16:29", type: "heat", h: [] },
    ...
    //                                      DOMINGO 01
    // ==========================================================================================
    // --- ESCENARIO COCA-COLA (Evento 5) y CONDITIONING (Evento X) ---
    // NOTA: Se ordenan estrictamente por hora de inicio para mostrar simultaneidad.
